const googleLogo =
  "http://localhost:3000/static/images/reviewslogo/google-logo.png";
const yelpLogo =
  "http://localhost:3000/static/images/reviewslogo/yelp-logo.png";
const yellowPagesLogo =
  "http://localhost:3000/static/images/reviewslogo/yellow-pages-logo.png";
const carGurusLogo =
  "http://localhost:3000/static/images/reviewslogo/cargurus-logo.png";
const carsLogo = "http://localhost:3000/static/images/reviewslogo/carslogo.png";
const dealerLogo =
  "http://localhost:3000/static/images/reviewslogo/dealer-logo.png";
const facebookLogo =
  "http://localhost:3000/static/images/reviewslogo/facebook-logo.png";
